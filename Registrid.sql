...
/*  Created On : 28-march-2022 19:15:07 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	"kood" char(1)	 NOT NULL,
	"nimetus" char(1)	 NOT NULL,
	CONSTRAINT "PK_Laadimispunkti_kategooria_tyyp" PRIMARY KEY ("kood")
)
;
...
(
	...
	"nimetus" char(1)	 NOT NULL,
	"kood" char(1)	 NOT NULL,
	CONSTRAINT "PK_Laadimispunkti_kategooria" PRIMARY KEY ("kood"),
	CONSTRAINT "FK_Laadimispunkti_kategooria_Laadimispunkti_katego" FOREIGN KEY ("kood") REFERENCES "Laadimispunkti_kategooria_tyyp" ("kood") ON DELETE No Action ON UPDATE Cascade
)
;
...
(
	...
	"isiku_seisundi_liik_kood" boolean NOT NULL DEFAULT TRUE,
...
(
	...
	CONSTRAINT "FK_Laadimispunkti_kategooria_omamine_Laadimispunkt" FOREIGN KEY ("Laadimispunkti_kood") REFERENCES "Laadimispunkt" ("Laadimispunkti_kood") ON DELETE No Action ON UPDATE Cascade,
	CONSTRAINT "FK_Laadimispunkti_kategooria_omamine_Laadimispunkt" FOREIGN KEY ("Laadimispunkti_kood") REFERENCES "Laadimispunkt" ("Laadimispunkti_kood") ON DELETE No Action ON UPDATE Cascade
)
;
