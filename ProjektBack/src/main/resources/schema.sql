...
CREATE DOMAIN nimetus AS varchar(255) NOT NULL CONSTRAINT CHK_nimetus_ei_ole_tyhi CHECK ( TRIM(VALUE ) <> '');
...
(
	...
	CONSTRAINT CHK_riik_kood_on_oige CHECK ( riik_kood ~ '[A-Z]{3}'),
     CONSTRAINT CHK_nimetus CHECK ( TRIM(riik_nimetus) <> '')
...
(
	...
	CONSTRAINT CHK_parool_ei_ole_tyhi CHECK ( TRIM(parool) <> '')
)
;
